...
use app\store\model\Category as GoodsCategory;
...
class Category extends Controller
{
    ...
    public function add()
    {
        ...
        if (!$this->request->isAjax()) {
			...
			$goodsCategory = GoodsCategory::getParentCategory();
			//dump($categoryList);exit;
            return $this->fetch('add',compact('categoryList','goodsCategory'));
        }
        // 新增记录
    ...
    public function edit($category_id)
    {
        ...
        if (!$this->request->isAjax()) {
			$categoryList = $model->getList();
			$goodsCategory = GoodsCategory::getParentCategory();			
            return $this->fetch('edit', compact('model','categoryList','goodsCategory'));
        }
        // 更新记录
