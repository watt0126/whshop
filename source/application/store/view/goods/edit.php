                ...
                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                    <div class="widget-body">
                        <fieldset>
							...
							<div class="am-form-group">
							    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">关联专家 </label>
							    <div class="am-u-sm-9 am-u-end">
							        <div class="widget-become-goods am-form-file am-margin-top-xs">
							            <button type="button"
							                    class="j-selectExpert upload-file am-btn am-btn-secondary am-radius">
							                <i class="am-icon-cloud-upload"></i> 选择专家
							            </button>
							            <div class="expert-list uploader-list am-cf">
											<?php foreach ($model['expert'] as $key => $item): ?>
											<div class="file-item">
												<a href="<?= $item['avatar_image'] ?>" title="点击查看大图" target="_blank">
													<img src="<?= $item['avatar_image'] ?>">
												</a>
												<input type="hidden" name="goods[experts][]"
							...
							<div class="am-form-group">
							    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">商品精选 </label>
							    <div class="am-u-sm-9 am-u-end">
							        <label class="am-radio-inline">
							            <input type="radio" name="goods[is_choice]" value="1" data-am-ucheck 
										<?= $model['is_choice'] == 1 ? 'checked' : '' ?>>
							            是
							        </label>
							        <label class="am-radio-inline">
							            <input type="radio" name="goods[is_choice]" value="0" data-am-ucheck 
										<?= $model['is_choice'] == 0 ? 'checked' : '' ?>>
							            否
							        </label>
							    </div>
							</div>
							...
							<div class="am-form-group">
							    <label class="am-u-sm-3 am-u-lg-2 am-form-label">初始浏览量</label>
							    <div class="am-u-sm-9 am-u-end">
							        <input type="number" class="tpl-form-input" name="goods[views_initial]"
							               value="<?= $model['views_initial'] ?>">
							    </div>
							</div>
                            <div class="am-form-group">
...
<!-- 专家列表模板 -->
<script id="tpl-expert-item" type="text/template">
    {{ each $data }}
    <div class="file-item">
        <a href="{{ $value.avatarUrl }}" title="{{ $value.expertTitle }} (ID:{{ $value.expert_id }})" target="_blank">
            <img src="{{ $value.avatarUrl }}">
        </a>
        <input type="hidden" name="goods[experts][]" value="{{ $value.expert_id }}">
    </div>
    {{ /each }}
</script>
<!-- 图片文件列表模板 -->
		...
		$('.j-selectExpert').click(function () {
		    ...
		    $.selectData({
		        ...
		        dataIndex: 'expert_id',
		            ...
		            //var expert = [data[0]];
		            $expertList.html(template('tpl-expert-item', data));
		        }
		    });
		});
        // 富文本编辑器
