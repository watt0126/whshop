                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">添加专家</div>
                            </div>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">专家封面图 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <div class="am-form-file">
                                        <div class="am-form-file">
                            ...
                            <div class="am-form-group am-padding-top">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <!-- 加载编辑器的容器 -->
                                    <textarea id="container" name="expert[expert_content]" type="text/plain"></textarea>
                                </div>
                            </div>
							<div class="am-form-group">
							    ...
							    <div class="am-u-sm-9 am-u-end">
									...
									placeholder="请输入专家其他文字描述"></textarea>							        
							    </div>
							</div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="expert[sign]"
                                           value="" placeholder="请输入标记" required>
